          ...
          <div className="sub-content top">
            ...
            <div className="sub-content left">
              ...
              <div className="blurb-wrapper">
                <p className="blurb">
                  I&#8216;m Jenna Rajani and love code for it&#8216;s endless
                  possibility. I enjoy focusing on the user-experience as well
                  as process efficiency while creating web applications.
                </p>
                <p className="blurb">
                  I have contributed to several large-scale applications and
                  many small, design centered, applications. When I&#8216;m not
                  coding you&#8216;ll find me either playing paino or planning
                  my next excurssion.
                </p>
              </div>
            </div>
          ...
          <div className="sub-content right">
            <div className="sub-header">
              ...
              <Link to={VARS.routePrefix + '/projects'}>
                See more <i className="fa fa-angle-right" aria-hidden="true" />
              </Link>
            </div>
            <div className="projects">
              <Link to={VARS.routePrefix + '/project/twinBridgesLake'}>
