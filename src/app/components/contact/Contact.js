...
class Contact extends Component {
    constructor(props) {
        super(props);
        setAndSendPageview(window, '/contact');
    }
    componentDidMount() {
        window.scrollTo(0, 0);
    }
            ...
            <div className="main-content">
                <div id="contact">
                    ...
                    <div className="sub-content left">
                        <div className="sub-header">
                            <a className="phone" href="tel:6786404262">
                                <i
                                    className="fa fa-whatsapp"
                                    aria-hidden="true"
                                />+1 678 640 4262
                            </a>
                            <a className="skype" href="skype:humdrum89">
                                <i
                            ...
                            <a
                                className="email"
                                href="mailto:jjrajani@gmail.com"
                            >
                                jjrajani@gmail.com
                            </a>
                        </div>
                    ...
                    <div className="sub-content right">
                        ...
                        <div className="hidden" id="thankyou_message">
                            <h2>
                                <em>Thanks</em> for contacting us! We will get
                                back to you soon!
                            </h2>
                        </div>
                    </div>
